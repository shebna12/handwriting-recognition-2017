...
class AboutScene(BaseScene):
	...
	def __init__(self, parent):
		...
		self.create_text(C_WINDOW_WIDTH/2 - 80, C_WINDOW_HEIGHT/2 - 96, 
			font="Helvetica 14", text="Developed by Team Dorme -1 ", 
...
class TTTClientGameGUI(TTTClientGame):
	...
	def __game_started__(self):
		...
		self.image_file_path_wizard = tkinter.PhotoImage('C:/Users/User/AppData/Local/Programs/Python/Python36-32/FinalProjectPictures/wizard.gif')
		...
		self.canvas.create_image((C_WINDOW_WIDTH/2 - 192, 
				C_WINDOW_HEIGHT/2 - 48), image=self.image_file_path_wizard);
