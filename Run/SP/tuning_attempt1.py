...
if __name__ == '__main__':
	...
	data,labels = feat_extract("ALL")
	data = np.squeeze(data) #Equivalent of flatten except that whole array
	...
	X_train, X_test, Y_train, Y_test = model_selection.train_test_split(data, labels, test_size=0.20, shuffle=True)
	...
	# print(best_score)
	# TRAINING
	svm_clf = svm.SVC(gamma = 0.01, C = 100)
